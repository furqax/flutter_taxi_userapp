...
class _BookingConfirmationState extends State<BookingConfirmation>
  ...
  void initState() {
    ...
    noDriverFound = false;
    etaDetails.clear();
    print("selecttttt booking confirmation");
    print("select widget.type ${widget.type}");
    getLocs();
    print(
        "selecttttt${addressList.isNotEmpty} $etaDetails ${userRequestData.isEmpty} $noDriverFound $tripReqError $lowWalletBalance");
    super.initState();
  }
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            style: GoogleFonts.roboto(
                                                                                ...
                                                                                color: (rentalChoosenOption == i) ? Colors.white : Colors.black),
                                                                          ),
                                                                        ),
                                                                      ));
                                                                })
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              children: [
                                                                                Column(
                                                                                  children: [
                                                                                    SizedBox(width: media.width * 0.1, child: const Icon(Icons.car_rental)),
                                                                                    Text(
                                                                                      "2m away",
                                                                                      style: GoogleFonts.roboto(fontSize: media.width * twelve, color: textColor.withOpacity(0.3)),
                                                                                    )
                                                                                ...
                                                                                Column(
                                                                                  crossAxisAlignment: CrossAxisAlignment.start,
                                                                                  children: [
                                                                                    Text("Toyoto gli ", style: GoogleFonts.roboto(fontSize: media.width * fourteen, color: textColor, fontWeight: FontWeight.w600)),
                                                                                    Row(
                                                                                      children: [
                                                                                        SizedBox(
                                                                                          width: media.width * 0.3,
