...
//base url
String url =
    'https://jumpi.app/public/'; //please add '/' at the end of the url as 'https://yourwebsite.com/'
String mapkey = 'AIzaSyCoFnwCtyqff6twmFdsRDFE4wnbi1PdNzY';
...
registerUser() async {
  ...
  try {
    ...
    print("register${respon.statusCode}");
...
etaRequest() async {
  print("select eta called");
  dynamic request;
  (addressList.where((element) => element.id == 'drop').isNotEmpty)
      ? request = jsonEncode({
  ...
  try {
    ...
    print("select response.body${response.statusCode}");
    if (response.statusCode == 200) {
      etaDetails = jsonDecode(response.body)['data'];
      print("select etadetails ${response.body}");
      choosenVehicle =
      ...
      debugPrint(response.body);
      print("select etadetails ${jsonDecode(response.body)['message']}");
...
etaRequestWithPromo() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      etaDetails = jsonDecode(response.body)['data'];
      print("select etarequest ${response.body}");
...
rentalEta() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      etaDetails = jsonDecode(response.body)['data'];
      print("select eta rental ${response.body}");
...
rentalRequestWithPromo() async {
  ...
  try {
    ...
    if (response.statusCode == 200) {
      etaDetails = jsonDecode(response.body)['data'];
      print("select eta promo ${response.body}");
...
createRequest() async {
  ...
  print("select create request $request");
  try {
    ...
    print("select create reuest status ${response.statusCode}");
    if (response.statusCode == 200) {
      print("select create request ${response.body}");
...
createRequestWithPromo() async {
  dynamic result;
  print("select create requestpromo");
  try {
    var response = await http.post(Uri.parse('${url}api/v1/request/create'),
        headers: {
          'Authorization': 'Bearer ${bearerToken[0].token}',
    ...
    if (response.statusCode == 200) {
      print("select create request promo ${response.body}");
...
createRequestLater() async {
  dynamic result;
  print("select create request later");
  try {
    var response = await http.post(Uri.parse('${url}api/v1/request/create'),
        headers: {
          'Authorization': 'Bearer ${bearerToken[0].token}',
    ...
    if (response.statusCode == 200) {
      print("select create request later ${response.body}");
...
createRequestLaterPromo() async {
  dynamic result;
  print("select create request later promo");
  try {
    var response = await http.post(Uri.parse('${url}api/v1/request/create'),
        headers: {
          'Authorization': 'Bearer ${bearerToken[0].token}',
    ...
    if (response.statusCode == 200) {
      print("select create request promo later ${response.body}");
...
createRentalRequest() async {
  dynamic result;
  print("select create rental request");
  try {
    var response = await http.post(Uri.parse('${url}api/v1/request/create'),
        headers: {
          'Authorization': 'Bearer ${bearerToken[0].token}',
    ...
    if (response.statusCode == 200) {
      userRequestData = jsonDecode(response.body)['data'];
      print("select create rental request  ${response.body}");
...
createRentalRequestWithPromo() async {
  print("select create rental request later");
  dynamic result;
  try {
    var response = await http.post(Uri.parse('${url}api/v1/request/create'),
        headers: {
    ...
    if (response.statusCode == 200) {
      print("select rental request later promo ${response.body}");
